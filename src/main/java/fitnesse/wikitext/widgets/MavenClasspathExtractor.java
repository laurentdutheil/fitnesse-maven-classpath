...
public class MavenClasspathExtractor {
	...
	public List<String> extractClasspathEntries(File pomFile) {
		return extractClasspathEntries(pomFile, DEFAULT_SCOPE, null);
	}

	public List<String> extractClasspathEntries(File pomFile, String scope, List<String> profiles) throws MavenClasspathExtractionException {
		...
		try {
			...
			if (profiles != null && !profiles.isEmpty()) {
				mavenRequest.setProfiles(profiles);
			}
